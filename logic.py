...
class DB_Manager:
    ...
    def create_tables(self):
        ...
        with conn:
            ...
            if 'image_filename' not in columns:
                conn.execute('ALTER TABLE projects ADD COLUMN image_filename TEXT')
            conn.commit()
    ...
    def insert_project(self, data):
        ...
        (user_id, project_name, url, status_id, image_filename) 
        values(?, ?, ?, ?, ?)"""
        self.__executemany(sql, data)
...
if __name__ == '__main__':
    ...
    data = ("botinyo", 'Test Project', 'https://github.com/KANAT37/pokemon', 3)
    manager.insert_project([data])

    param = "description"
    data = ("pokemoninyo", 'Test Project', 'botinyo')